...
$this->title = Yii::t('app', 'รายการงานสิ้นสุด');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ticket-index">
    <p><?= Html::a('<i class="fa-solid fa-home"></i> ' . Yii::t('app', 'Home'), ['index-complete'], ['class' => 'btn btn-primary btn-sm btn-w100']) ?></p>
    <div class="card">
        <div class="card-header text-white bg-success"> <?= $this->title ?> </div>
        <div class="card-body">
            <div class="row">

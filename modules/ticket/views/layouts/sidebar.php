        ...
        <nav class="mt-2 nav-flat nav-compact">
            <?= \hail812\adminlte\widgets\Menu::widget([
                ...
                'items' => [
                    ...
                    ['label' => Yii::t('app', 'แจ้งงาน'), 'url' => ['/ticket/ticket/create'], 'iconStyle' => 'fa', 'icon' => 'fa-solid fa-cart-arrow-down'],
                    ['label' => Yii::t('app', 'รายการแจ้งของแผนก'), 'url' => ['/ticket/ticket/index-d'], 'iconStyle' => 'fa', 'icon' => 'fa-regular fa-rectangle-list'],

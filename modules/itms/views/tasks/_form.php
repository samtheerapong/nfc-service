...
use app\modules\itms\models\TaskDepartments;
use app\modules\itms\models\TaskStatus;
use app\modules\itms\models\TaskTypes;
...
<div class="tasks-form">
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            ...
            <?= $form->field($model, 'task_date')->widget(
                DatePicker::class,
                [
                    'options' => [
                        'required' => true,
            ...
            <?= $form->field($model, 'user_request')->widget(Select2::class, [
                'data' => ArrayHelper::map(

...
/** @var app\modules\itms\models\search\MonitorsSearch $model */
...
<div class="monitors-search">
    ...
    <?= $form->field($model, 'monitor_name') ?>

    <?= $form->field($model, 'monitor_type') ?>

    <?php // echo $form->field($model, 'screen_size_inch') ?>

    <?php // echo $form->field($model, 'connectivity_types_id') ?>
